...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ReferencedDataConfig) DeepCopyInto(out *ReferencedDataConfig) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ReferencedDataConfig.
func (in *ReferencedDataConfig) DeepCopy() *ReferencedDataConfig {
	if in == nil {
		return nil
	}
	out := new(ReferencedDataConfig)
	in.DeepCopyInto(out)
	return out
}
...
func (in *WorkloadOperator) DeepCopyInto(out *WorkloadOperator) {
	*out = *in
	...
	out.ReferencedData = in.ReferencedData
}
