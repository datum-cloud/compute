...
// Package milo provides a multicluster provider that discovers Kubernetes clusters
// by watching Milo Project (and ProjectControlPlane) resources.
//
// This is a local fork of go.miloapis.com/milo/pkg/multicluster-runtime/milo adapted
// to be compatible with multicluster-runtime v0.23+, which changed ClusterName from a
// plain string to a distinct type (multicluster.ClusterName).
package milo
