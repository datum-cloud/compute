...
/**
 * `window` is the rate window. Charts use 1m for resolution; instant "card"
 * queries should use a wider window (e.g. 5m) so bursty, low-volume traffic
 * such as a handful of 503s does not fall between scrapes and read as 0.
 */
